...
group :development do
  ...
  gem "rack-mini-profiler", "~> 4.0", ">= 4.0.0", require: false
  gem "stackprof", "~> 0.2"
end
...
group :test do
  ...
  gem "vcr", "~> 6.1"
  gem "webmock", "~> 3.24", ">= 3.24.0", require: "webmock/rspec"
...
gem "paypal-sdk-merchant", "~> 1.117", ">= 1.117.4"
...
gem "rack-utf8_sanitizer", "~> 1.10", ">= 1.10.0"
gem "ratelimit", "~> 1.0"
gem "redcarpet", "~> 3.5"
gem "redis", "~> 5.0"
...
gem "terser", "~> 1.1"
gem "twitter", "~> 8.0"
gem "valvat", "~> 2.0", ">= 2.0.0"
gem "warden", "~> 1.2"
gem "webdrivers", "~> 5.2"
gem "zip-zip", "~> 0.3"
gem "rouge", "~> 4.0"
gem "ruby-openai", "~> 7.0"
gem "anycable-rails", "~> 1.6", ">= 1.6.0"
